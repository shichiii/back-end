...
class customAdvertisementCreateSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'owner_id', 'location', 'start_date', 'end_date', 'price', 'description', 'created_date', 'car_images', 'car_name', 'car_color', 'car_produced_date','car_seat_count','car_door_count', 'car_Is_cooler', 'car_gearbox', 'car_fuel', 'car_category']
...
class customAdvertisementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomAdvertisement
        fields = ['id', 'average_rating', 'owner_id', 'location', 'start_date', 'end_date', 'price', 'description', 'created_date', 'car_images', 'car_name', 'car_color', 'car_produced_date', 'car_seat_count','car_door_count', 'car_Is_cooler', 'car_gearbox', 'car_fuel', 'car_category']
